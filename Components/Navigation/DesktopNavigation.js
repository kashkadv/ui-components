...
function DesktopNavigation() {
  ...
  const barClassNames = scrolled ? 'bg-white/90 backdrop-blur-sm mb-24 w-full shadow-lg duration-700' : 'mx-24 bg-white shadow-sm backdrop-blur-none duration-300'

  return (
    <div className={`group mt-24 z-10 w-full flex ${wrapperClassNames}`}>
